      ...
      <div ref={scrollWrapperRef} className="scroll-wrapper">
        ...
        <div className="sticky-container">
          ...
          <div ref={horizontalTrackRef} className="horizontal-track">
            ...
            ════════════════════════════════════════ */}
            <section id='about' className="section  bg-[#F5F0EB] flex items-center relative">
              ...
              <div className="relative z-10 w-full h-full flex items-center">
                <div className="w-full max-w-[1400px] mx-auto px-8 md:px-16 lg:px-24 flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
