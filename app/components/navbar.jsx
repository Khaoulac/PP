...
const navbar = () => {
  ...
  <div className="mx-auto max-w-7xl px-6 py-5 flex items-center justify-between">
    ...
    <Link href="/pages/login" className="rounded-full bg-cream text-ink font-bold border-gray-500  text-black text-sm bg-white  px-5 py-2.5 hover:bg-black hover:text-white transition">Log In</Link>

    <Link href="/pages/signup" className="rounded-full bg-cream text-ink font-bold  text-white text-sm bg-gray-950   px-5 py-2.5 hover:bg-white hover:text-black transition">Sign Up</Link>
    </div>
  </div>
</header>
    </>
