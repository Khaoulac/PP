...
const navbarClients = () => {
  ...
  <div className="mx-auto max-w-7xl px-6 py-5 flex items-center justify-between">
    ...
    <nav  className="hidden md:flex items-center gap-6 rounded-full bg-white/10 backdrop-blur-md border border-white/15 px-4 py-2">
         <Link href="/clients/home" className="text-gray-800 hover:text-white transition" >Home</Link>
          <Link href="/clients/shop" className="text-gray-800 hover:text-white transition">Shop</Link>
          <Link href="/clients/services" className="text-gray-800 hover:text-white transition">Services</Link>
          <Link href="/clients/services" className="text-gray-800 hover:text-white transition">Orders</Link>
          <Link href="/clients/home/#about" className="text-gray-800 hover:text-white transition">About Us</Link>
          <Link href="/clients/home/#contact" className="text-gray-800 hover:text-white transition">Contact</Link>
    </nav>
    <div className='flex gap-5'>
    <Link href="/clients/profile" className="rounded-full bg-cream text-ink font-bold  text-black text-sm bg-blue-50  px-5 py-2.5 hover:bg-black hover:text-white transition" ></Link>
 </div>
  </div>
</header>
    </>
