...
const page = () => {
  ...
  const transactions = [
    { id: 'TRX-7829', customer: 'Sarah Johnson', email: 'sarah.j@example.com', amount: 1299.00, method: 'Visa •••• 4242', date: '2024-01-15', status: 'Completed' },
    { id: 'TRX-7828', customer: 'Michael Chen', email: 'm.chen@example.com', amount: 849.50, method: 'Mastercard •••• 8891', date: '2024-01-15', status: 'Completed' },
    { id: 'TRX-7827', customer: 'Emma Williams', email: 'emma.w@example.com', amount: 2499.00, method: 'PayPal', date: '2024-01-14', status: 'Pending' },
    { id: 'TRX-7826', customer: 'James Brown', email: 'james.b@example.com', amount: 599.00, method: 'Visa •••• 1234', date: '2024-01-14', status: 'Refunded' },
    { id: 'TRX-7825', customer: 'Olivia Davis', email: 'olivia.d@example.com', amount: 1899.00, method: 'Amex •••• 0005', date: '2024-01-13', status: 'Completed' },
    { id: 'TRX-7824', customer: 'William Miller', email: 'w.miller@example.com', amount: 349.00, method: 'Visa •••• 4242', date: '2024-01-13', status: 'Failed' },
    { id: 'TRX-7823', customer: 'Sophia Wilson', email: 'sophia.w@example.com', amount: 1599.00, method: 'Mastercard •••• 8891', date: '2024-01-12', status: 'Completed' },
    { id: 'TRX-7822', customer: 'Daniel Moore', email: 'daniel.m@example.com', amount: 799.00, method: 'PayPal', date: '2024-01-12', status: 'Pending' },
  ];
      ...
      <div className="max-w-7xl mr-auto space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-gray-500 mt-1">Manage and track all your payment transactions</p>
          </div>
          <button className="inline-flex items-center gap-2 px-4 py-2.5 bg-gray-900 text-white rounded-lg hover:bg-gray-800 transition-colors text-sm font-medium shadow-sm">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <div className="space-y-4">
              {[
                { method: 'Credit Card', percentage: 65, color: 'bg-gray-900' },
                { method: 'PayPal', percentage: 20, color: 'bg-gray-600' },
                { method: 'Bank Transfer', percentage: 10, color: 'bg-gray-400' },
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <h3 className="text-base font-semibold text-gray-900 mb-4">Transaction Status</h3>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <div className="space-y-4">
              {[
                { action: 'Payment received', detail: 'From Sarah Johnson', time: '2 min ago', icon: DollarSign, color: 'text-emerald-600 bg-emerald-50' },
                { action: 'Refund processed', detail: 'To James Brown', time: '15 min ago', icon: RefreshCcw, color: 'text-blue-600 bg-blue-50' },
                { action: 'Payment failed', detail: 'From William Miller', time: '1 hour ago', icon: XCircle, color: 'text-rose-600 bg-rose-50' },
                { action: 'New subscription', detail: 'Emma Williams', time: '3 hours ago', icon: CreditCard, color: 'text-gray-600 bg-gray-50' },
              ].map((activity, index) => (
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-gray-50/50 border-b border-gray-100">
                  <th className="text-left py-3.5 px-6 text-xs font-semibold text-gray-500 uppercase tracking-wider">Transaction ID</th>
                  ...
                  <th className="text-left py-3.5 px-6 text-xs font-semibold text-gray-500 uppercase tracking-wider">Method</th>
                ...
                {transactions.map((transaction) => (
                  <tr key={transaction.id} className="hover:bg-gray-50/50 transition-colors group">
                    <td className="py-4 px-6">
                      <span className="text-sm font-mono font-medium text-gray-900">{transaction.id}</span>
                    </td>
                    <td className="py-4 px-6">
                      <div className="flex items-center gap-3">
                    ...
                    <td className="py-4 px-6">
                      <span className="text-sm font-semibold text-gray-900">${transaction.amount.toLocaleString('en-US', { minimumFractionDigits: 2 })}</span>
                    </td>
                    <td className="py-4 px-6">
          ...
          <div className="px-6 py-4 border-t border-gray-100 flex items-center justify-between">
            <p className="text-sm text-gray-500">Showing 1-8 of 2,451 transactions</p>
            <div className="flex items-center gap-2">
              <button className="px-3 py-1.5 text-sm font-medium text-gray-500 bg-white border border-gray-200 rounded-lg hover:bg-gray-50 disabled:opacity-50" disabled>
                Previous
              </button>
