// CeraServicesPage.jsx
// Services page with booking forms for Cera Ceramics Studio
// Includes: Workshop Booking, Custom Commission, Kiln Firing, Contact forms
'use client'
...
// ============================================
const FormField = ({ label, name, type = 'text', placeholder, required = false, options, value, onChange, textarea = false }) => (
  <div className="mb-5">
...
// ============================================
const ServiceCard = ({ icon, title, description, price, duration, active, onClick }) => (
  <div 
    onClick={onClick}
  ...
  >
    ...
    <h3 className="font-serif text-xl font-medium text-[#3D3228] mb-2">{title}</h3>
...
const page = () => {
  // Active service tab
  const [activeService, setActiveService] = useState('workshop');
  ...
  const handleSubmit = useCallback(async (e) => {
    ...
    setTimeout(() => {
      ...
      setFormData({
        ...
        participants: '1', experience: '', serviceType: 'beginner',
        pieceType: '', dimensions: '', glazePreference: '', message: '', newsletter: false,
      });
    }, 4000);
  }, []);
  ...
  const services = [
    {
      ...
      description: 'Hands-on wheel throwing and hand-building sessions for all skill levels. Materials and firing included.',
      price: '$65',
      duration: '2.5 hours',
    },
    {
      ...
      description: 'Bespoke ceramic pieces crafted to your vision. From personalized mugs to sculptural centerpieces.',
      price: 'From $120',
      duration: '2–4 weeks',
    },
    {
      ...
      description: 'Professional bisque and glaze firing for your creations. Multiple kiln sizes available.',
      price: '$25–$80',
      duration: 'Per piece',
    },
    {
      ...
      title: 'Private Event',
      description: 'Team building, birthdays, and group experiences. Up to 12 people with dedicated instructor.',
      price: '$450',
      duration: '3 hours',
    },
  ];
  ...
  return (
    ...
    <div className="min-h-screen bg-[#faf7f3]">
      ...
      <section className="relative py-24 md:py-32 px-6 md:px-16 overflow-hidden">
        ...
        <div className="floating-orb w-80 h-80 bg-[#D4C4B0] bottom-[-10%] left-[-5%] float-anim" style={{ animationDelay: '3s' }} />
        
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          <Reveal>
            <span className="text-xs font-semibold tracking-[0.3em] uppercase text-[#8A7E72] mb-4 block">What We Offer</span>
          </Reveal>
          ...
          <Reveal delay="reveal-delay-2">
            <p className="text-[#8A7E72] text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
              From immersive workshops to bespoke commissions, we offer a range of ceramic experiences designed to inspire creativity and craft something truly personal.
            </p>
          </Reveal>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          <Reveal>
            <div className="text-center mb-12">
              <span className="text-xs font-semibold tracking-[0.3em] uppercase text-[#8A7E72] mb-3 block">Book Your Experience</span>
            ...
            <div className="glass-card p-8 md:p-12">
              {submitted ? (
                ...
                <div className="text-center py-12">
                  ...
                  <h3 className="font-serif text-2xl font-medium text-[#3D3228] mb-2">Booking Received!</h3>
                  <p className="text-[#8A7E72]">We'll send a confirmation to {formData.email} shortly.</p>
                </div>
              ) : (
                /* Form */
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="flex items-start gap-3 mb-8">
                    ...
                    />
                    <label htmlFor="newsletter" className="text-sm text-[#8A7E72] cursor-pointer">
                      Send me workshop updates, new collection previews, and studio news.
                    </label>
                  </div>
      ...
      <section className="px-6 md:px-16 py-16 md:py-24 bg-[#F0EBE3]">
        <div className="max-w-3xl mx-auto">
          <Reveal>
            <div className="text-center mb-12">
              <span className="text-xs font-semibold tracking-[0.3em] uppercase text-[#8A7E72] mb-3 block">Common Questions</span>
              ...
              <Reveal key={i} delay={`reveal-delay-${(i % 3) + 1}`}>
                <div className="glass-card p-6">
                  <h4 className="font-medium text-[#3D3228] mb-2 flex items-start gap-3">
                    <span className="text-[#B8916A] font-serif text-lg">Q.</span>
                    {faq.q}
                  </h4>
      ...
      <section className="px-6 md:px-16 py-16 md:py-24 relative overflow-hidden">
        <div className="floating-orb w-96 h-96 bg-[#C4A882] top-[-10%] left-[-5%] float-anim" style={{ animationDelay: '2s' }} />
          ...
          <Reveal>
            <div className="glass-card-dark p-10 md:p-16 text-center">
              ...
              <p className="text-[#D4C4B0] max-w-lg mx-auto mb-8">
                We'd love to chat about your ideas and help you choose the perfect experience. Reach out anytime.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="mailto:hello@cerastudio.com" className="btn-primary inline-flex justify-center">
                ...
                <a href="tel:+15552345678" className="btn-secondary inline-flex justify-center items-center gap-2">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      ...
      {/* ============================================
          FOOTER
      ============================================ */}
      <footer className="bg-[#3D3228] py-12 px-8 text-center">
        <div className="max-w-4xl mx-auto">
          <div className="font-serif text-2xl text-[#F5F0EB] mb-4">Cera</div>
          <p className="text-[#8A7E72] text-sm mb-6">Handcrafted with love since 2018</p>
          <div className="flex justify-center gap-6 text-[#8A7E72] text-sm mb-8">
            {['Privacy', 'Terms', 'Shipping', 'Returns'].map((link) => (
              <a key={link} href="#" className="hover:text-[#C4A882] transition-colors">{link}</a>
            ))}
          </div>
          <div className="flex justify-center gap-4">
            {['Facebook', 'Instagram', 'Twitter'].map((social) => (
              <a key={social} href="#" className="w-10 h-10 rounded-xl glass-card-dark flex items-center justify-center text-[#8A7E72] hover:text-[#C4A882] transition-all">
                <span className="text-xs">{social[0]}</span>
              </a>
            ))}
          </div>
          <p className="text-[#8A7E72]/50 text-xs mt-8">© 2026 Cera Ceramics Studio. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
